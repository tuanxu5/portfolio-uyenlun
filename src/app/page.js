                ...
                <div className="lg:col-span-2">
                  ...
                  <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 border border-gray-200/50 shadow-sm">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      ...
                      management systems, and microservices architecture. I'm always eager to learn new technologies and
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        ...
                        and microservices architecture. Strong understanding of server-side optimization and performance
                        tuning.
                      </p>
                    </div>
                    <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 shadow-sm">
                      ...
                      <p className="text-gray-600 text-sm leading-relaxed">
                        Believes in clean code, thorough testing, and comprehensive documentation. Values collaboration,
                        continuous improvement, and building solutions that solve real-world problems effectively.
                      </p>
                    </div>
                  </div>
                </div>
